  ...
  class FileStatus extends React.Component {
    render() {
      ...
      var icon = wp.element.createElement(
        'img',
        { id: this.props.id, class: 'acclectic-uploader-file-icon', src: config.assetsPath + iconFile });
      var progressBar = wp.element.createElement(FileStatusProgressBar, { percent: percentDone, id: this.props.id });
